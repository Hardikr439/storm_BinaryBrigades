...
function Employer(){
  return (
    <>
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-2">Create Feedback</a></li>
        <li><a href="#" class="nav-link px-2">View</a></li>
        <li><a href="#" class="nav-link px-2">Results</a></li>
      </ul>

        <div class="col-md-3 text-end">
            <button type="button" class="btn btn-outline-primary me-2 m-2">Employee</button>
  ...
  <button class="btn btn-danger p-3 lh-1" type="button">
    ...
    <h6 class="border-bottom pb-2 mb-0 text-success text-center">Created & active forms</h6>
    ...
    <div class="d-flex text-body-secondary pt-3 mx-4">
      ...
      <p class="pb-3 mb-0 small lh-sm border-bottom mx-2">
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem consequatur quibusdam ipsum illum nulla perferendis nemo amet eum similique rerum!
      </p>
    </div>
